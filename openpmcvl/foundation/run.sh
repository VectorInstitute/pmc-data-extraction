...
# noncomm license
nohup python -u src/fetch_oa.py --num-retries 5 --extraction-dir /datasets/PMC-15M/non_comm2 --license-type noncomm --volumes 0 > output.txt
nohup python -u src/fetch_oa.py --num-retries 5 --extraction-dir /datasets/PMC-15M/non_comm2 --license-type noncomm --volumes 1 > /datasets/PMC-15M/non_comm2/output_v1.txt
# other license
...
# dev
python -u src/fetch_oa.py --num-retries 5 --extraction-dir ./PMC_OA2 --license-type noncomm --volumes 0
