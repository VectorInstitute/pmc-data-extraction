...
stdbuf -oL -eL srun python3 openpmcvl/granular/pipeline/subfigure.py \
  ...
  --eval_file /datasets/PMC-15M/granular/medical_granular.jsonl \
  --img_root /datasets/PMC-15M/figures \
  --save_path /datasets/PMC-15M/granular/subfigures2 \
  --rcd_file /datasets/PMC-15M/granular/subfigures2.jsonl  \
  --score_threshold 0.5 \
  --nms_threshold 0.4 \
  --batch_size 8 \
  --num_workers 4 \
