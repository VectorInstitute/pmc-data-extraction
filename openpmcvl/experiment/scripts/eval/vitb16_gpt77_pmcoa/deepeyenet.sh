mmlearn_run --multirun hydra.launcher.mem_gb=64 \
    ...
    experiment_name=vitb16_gpt77_pmcoa_retrieval_deepeyenet \
    job_type=eval \
    ~datasets.test.pmcoa \
    ...
    resume_from_checkpoint="/projects/multimodal/checkpoints/openpmcvl/pmc_oa/gpt77/epoch\=31-step\=10304.ckpt"
