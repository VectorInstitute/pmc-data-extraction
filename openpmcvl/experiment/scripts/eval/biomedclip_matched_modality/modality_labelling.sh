...
# ------------------- Using Imagenet checkpoint ------------------------------------------------------------ 3 labels
mmlearn_run --multirun hydra.launcher.mem_gb=0 \
    hydra.launcher.qos=a40_arashaf_multimodal \
    hydra.launcher.partition=a40 \
    hydra.launcher.gres=gpu:4 \
    ...
    'hydra.searchpath=[pkg://openpmcvl.experiment.configs]' \
    +experiment=modality_labelling \
    experiment_name=3_modality_labelling \
    task.num_classes=3 \
    job_type=eval \
    task.output_file_name="pmcoa_2_test_imagenet_3_labels" \
    task.encoder_checkpoint_path="/projects/DeepLesion/projects/pmc-data-extraction/outputs/3_modality_imagenet/2024-11-01/22-05-25/0_13825487/multimodal/cpjey1j4/checkpoints/epoch\=39-step\=2160.ckpt"