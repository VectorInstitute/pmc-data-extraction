...
mmlearn_run --multirun hydra.launcher.mem_gb=0 \
    ...
    experiment_name=vitb16_bert256_train_lr2e-4_matched \
    ...
    resume_from_checkpoint="/checkpoint/yaspar/13699477/last.ckpt" \
    trainer.logger.wandb.id="t2q56307" \
