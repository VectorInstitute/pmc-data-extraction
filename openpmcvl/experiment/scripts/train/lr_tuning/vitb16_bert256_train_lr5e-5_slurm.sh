...
mmlearn_run --multirun hydra.launcher.mem_gb=0 \
    ...
    experiment_name=vitb16_bert256_train_lr5e-5_matched \
    ...
    resume_from_checkpoint="/checkpoint/yaspar/13699480/last.ckpt" \
    trainer.logger.wandb.id="oqmn4p3w" \
