...
mmlearn_run --multirun hydra.launcher.mem_gb=0 \
    ...
    experiment_name=vitb16_bert256_train_lr1e-5_matched \
    ...
    resume_from_checkpoint="/checkpoint/yaspar/13670078/last.ckpt" \
    trainer.logger.wandb.id="0akgrzgi" \
