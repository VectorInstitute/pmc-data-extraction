...
srun --ntasks $SLURM_NNODES --tasks-per-node=1 python -u openpmcvl/experiment/scripts/compute_canada/test.py
# srun python -u openpmcvl/experiment/scripts/compute_canada/test.py
