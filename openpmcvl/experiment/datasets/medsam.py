...
@external_store(group="datasets", root_dir=os.getenv("MEDSAM_ROOT_DIR"))
class MedSAM(Dataset[Example]):
    """MedSAM dataset for medical imaging modalities.
    ...
    def __getitem__(self, idx: int) -> Example:
        ...
        # Convert numpy array to PIL Image before applying any transformations
