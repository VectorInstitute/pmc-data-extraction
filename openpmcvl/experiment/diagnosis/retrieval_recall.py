...
def instantiate_contrastive_pretraining() -> ContrastivePretraining:
...
def instantiate_mimic(batch_size: int, num_workers: int) -> DataLoader[Dict[str, Any]]:
...
def save_embeddings(embeddings: Dict[str, torch.Tensor], root_dir: str = "./") -> None:
